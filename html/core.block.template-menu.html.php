...
?>
<?php if (setting('cm_linked_fox_menu_type') == 'horizontal') : ?>
    {if $bOnlyMobileLogin}
    ...
    <ul class="nav navbar-nav visible-xs visible-sm site_menu">
        ...
        <li class="">
            <div id="search-panel2">
                ...
                <form method="get" action="{url link='search'}" class="header_search_form_sm"
                      id="header_search_form_sm">
                    <div class="input-group has-feedback">
                        <input type="text" name="q" placeholder="{_p var='Search...'}" autocomplete="off"
                               class="form-control js_temp_friend_search_input in_focus"
                               id="header_sub_menu_search_input"/>
...
<?php else: ?>
    ...
    <ul class="nav visible-xs visible-sm site_menu">
        {if Phpfox::isUser() && Phpfox::getUserParam('search.can_use_global_search')}
        <li class="">
            <div id="search-panel2">
                <div class="js_temp_friend_search_form"></div>
    ...
    <div class="ember-view">
        <?php if (setting('cm_linked_fox_menu_type') == 'horizontal') : ?>
        <ul class="nav-app-vertical__menu visible-md visible-lg site_menu" data-component="menu">
            <div class="overlay"></div>
            {if Phpfox::getUserBy('profile_page_id') <= 0 && isset($aMainMenus)}
            {plugin call='theme_template_core_menu_list'}
        ...
        <?php else: ?>
            <div class="title_menu visible-md visible-lg">{_p var='apps'}</div>
            <ul class="nav-app-vertical__menu visible-md visible-lg site_menu" data-component="menu">
                <div class="overlay"></div>
                {if Phpfox::getUserBy('profile_page_id') <= 0 && isset($aMainMenus)}
                {plugin call='theme_template_core_menu_list'}
